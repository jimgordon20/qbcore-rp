    ...
    setup() {
        ...
        function UpdateHudData(data) {
            ...
            if (data.armor !== undefined) {
                ...
                armorColor.value = data.armor <= 0 ? "#FF0000" : "#326dbf";
            }

            if (data.hunger !== undefined) {
                hunger.value = data.hunger;
                hungerColor.value = data.hunger <= 30 ? "#ff0000" : "#dd6e14";
            }

            if (data.thirst !== undefined) {
                thirst.value = data.thirst;
                thirstColor.value = data.thirst <= 30 ? "#ff0000" : "#1a7cad";
            }
        ...
        function UpdateMoney(cashAmount, bankAmount, updateAmount, isMinus, type) {
        ...
        function setupEventListeners() {
            ue.interface.IsTalking = IsTalking;
            ue.interface.UpdateHudData = UpdateHudData;
            ue.interface.UpdateMoney = UpdateMoney;
            ue.interface.UpdateVehicleStats = UpdateVehicleStats;
            ue.interface.UpdateWeaponAmmo = UpdateWeaponAmmo;
            ue.interface.UpdateVoiceVolume = UpdateVoiceVolume;
            ue.interface.ShowCashAmount = ShowCashAmount;
            ue.interface.ShowBankAmount = ShowBankAmount;
            ue.interface.ShowSpeedometer = ShowSpeedometer;
            ue.interface.ShowWeapon = ShowWeapon;
        }
